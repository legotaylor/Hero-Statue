...
public class StatuePoseOneModel extends StatuePoseModel {
	public StatuePoseOneModel(ModelPart root) {
		super(root);
	}
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r2 = cape.addChild("cube_r2", ModelPartBuilder.create().uv(0, 42).cuboid(-7.0F, -6.0F, 0.0F, 14.0F, 21.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(1.0F, 3.0F, 1.0F, 0.2182F, 0.0F, 0.0F));

		ModelPartData left_leg = base.addChild("left_leg", ModelPartBuilder.create().uv(0, 63).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(2.0F, -11.0F, 1.0F, -0.0436F, 0.0F, -0.0873F));
		...
		ModelPartData right_leg = base.addChild("right_leg", ModelPartBuilder.create().uv(16, 65).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -11.0F, 1.0F, 0.0873F, 0.0F, 0.0873F));
