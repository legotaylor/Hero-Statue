...
public class StatuePoseTenModel extends StatuePoseModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = base.addChild("body", ModelPartBuilder.create().uv(50, 13).cuboid(-4.0F, -10.75F, -2.325F, 8.0F, 12.0F, 4.0F, new Dilation(0.0F)), pivot(0.0F, -12.0F, 1.0F, 0.0F, 0.0F, 0.0F));
		...
		ModelPartData left_arm = body.addChild("left_arm", ModelPartBuilder.create().uv(32, 65).cuboid(-3.1642F, -1.4142F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(64, 65).cuboid(-3.4142F, -2.4142F, -3.0F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), pivot(7.0F, -10.0F, -0.25F, -0.4295F, 0.0651F, -0.577F));
		...
		ModelPartData right_arm = body.addChild("right_arm", ModelPartBuilder.create().uv(48, 65).cuboid(-0.8358F, -1.4142F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(68, 37).cuboid(-1.5858F, -2.4142F, -3.0F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), pivot(-6.0F, -10.0F, 0.75F, 0.4831F, 0.1308F, 2.6872F));
		...
		ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-6.5F, -8.5F, -5.5F, 13.0F, 11.0F, 11.0F, new Dilation(0.0F))
			...
			.uv(78, 9).cuboid(4.5F, 2.5F, -5.5F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), pivot(0.0F, -12.5F, -0.5F, -0.176F, 0.1289F, -0.0229F));

		ModelPartData cape = body.addChild("cape", ModelPartBuilder.create(), pivot(-1.0F, -14.0F, 2.0F, 0.0F, 0.0F, 0.0F));

		ModelPartData cube_r1 = cape.addChild("cube_r1", ModelPartBuilder.create().uv(0, 42).cuboid(-7.0F, -6.0F, 0.0F, 14.0F, 21.0F, 0.0F, new Dilation(0.001F)), pivot(1.0F, 5.0F, 1.0F, 0.5672F, 0.0F, 0.0F));

		ModelPartData left_leg = base.addChild("left_leg", ModelPartBuilder.create().uv(0, 63).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), pivot(2.5F, -11.25F, 1.0F, 0.0336F, 0.1338F, -0.0442F));
		...
		ModelPartData right_leg = base.addChild("right_leg", ModelPartBuilder.create().uv(16, 65).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), pivot(-2.5F, -11.25F, 1.0F, 0.1314F, -0.1232F, 0.0317F));
