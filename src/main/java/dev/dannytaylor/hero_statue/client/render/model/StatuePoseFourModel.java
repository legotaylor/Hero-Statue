...
public class StatuePoseFourModel extends StatuePoseModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData left_arm = body.addChild("left_arm", ModelPartBuilder.create().uv(32, 65).cuboid(-1.75F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(64, 65).cuboid(-2.0F, -1.0F, -3.0F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), pivot(6.0F, -12.0F, 0.0F, 0.4379F, -0.0211F, -0.058F));
		...
		ModelPartData right_arm = body.addChild("right_arm", ModelPartBuilder.create().uv(48, 65).cuboid(-2.25F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(68, 37).cuboid(-3.0F, -1.0F, -3.0F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), pivot(-6.0F, -12.0F, 0.0F, -0.4379F, -0.0211F, 0.058F));
		...
		ModelPartData cube_r2 = cape.addChild("cube_r2", ModelPartBuilder.create().uv(0, 42).cuboid(-7.0F, -6.0F, 0.0F, 14.0F, 21.0F, 0.0F, new Dilation(0.001F)), pivot(1.0F, 3.0F, 1.0F, 0.829F, 0.0F, 0.0F));

		ModelPartData left_leg = base.addChild("left_leg", ModelPartBuilder.create(), pivot(2.0F, -11.0F, 1.0F, -0.436F, -0.0184F, -0.0395F));
		...
		ModelPartData right_leg = base.addChild("right_leg", ModelPartBuilder.create(), pivot(-2.0F, -11.0F, 1.0F, 0.4363F, 0.0F, 0.0F));
