...
public class StatuePoseFiveModel extends StatuePoseModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r1 = body.addChild("cube_r1", ModelPartBuilder.create().uv(50, 13).cuboid(-4.0F, -6.0F, -2.0F, 8.0F, 12.0F, 4.0F, new Dilation(0.0F)), pivot(0.0F, -6.0F, 0.0F, 0.0F, 0.0F, -0.0436F));
		...
		ModelPartData left_arm = body.addChild("left_arm", ModelPartBuilder.create().uv(32, 65).cuboid(-1.75F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(64, 65).cuboid(-2.0F, -1.0F, -3.0F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), pivot(6.0F, -12.0F, 0.0F, -0.522F, -0.0211F, -0.058F));
		...
		ModelPartData right_arm = body.addChild("right_arm", ModelPartBuilder.create().uv(48, 65).cuboid(-2.25F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(68, 37).cuboid(-3.0F, -1.0F, -3.0F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), pivot(-6.0F, -12.0F, 0.0F, 0.4348F, -0.0211F, 0.058F));
		...
		ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-6.5F, -10.5F, -5.5F, 13.0F, 11.0F, 11.0F, new Dilation(0.0F))
			...
			.uv(78, 9).cuboid(4.5F, 0.5F, -5.5F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), pivot(0.0F, -12.5F, -0.5F, 0.1091F, 0.0F, 0.0F));

		ModelPartData cape = body.addChild("cape", ModelPartBuilder.create(), pivot(-1.0F, -14.0F, 2.0F));

		ModelPartData cube_r2 = cape.addChild("cube_r2", ModelPartBuilder.create().uv(0, 42).cuboid(-7.0F, -6.0F, 0.0F, 14.0F, 21.0F, 0.0F, new Dilation(0.001F)), pivot(1.0F, 3.0F, 1.0F, 0.6545F, 0.0F, 0.0F));

		ModelPartData left_leg = base.addChild("left_leg", ModelPartBuilder.create(), pivot(2.0F, -11.0F, 1.0F, 0.3931F, -0.0184F, -0.0395F));
		...
		ModelPartData left_leg_r1 = left_leg.addChild("left_leg_r1", ModelPartBuilder.create().uv(0, 63).cuboid(-3.0F, -12.0F, -1.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), pivot(1.0F, 11.0F, -1.0F, 0.0F, 0.0436F, 0.0F));

		ModelPartData right_leg = base.addChild("right_leg", ModelPartBuilder.create(), pivot(-2.0F, -11.0F, 1.0F, -0.2618F, 0.0F, 0.0F));
		...
		ModelPartData right_leg_r1 = right_leg.addChild("right_leg_r1", ModelPartBuilder.create().uv(16, 65).cuboid(-3.0F, -12.0F, -1.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), pivot(1.0F, 11.0F, -1.0F, 0.0F, 0.0436F, 0.0F));
